            ...
            builder: (context, state) {
              return Scaffold(
                ...
                drawer: responsive.isMobile &&
                        (state.isSidebarVisible || state.isFirstMessageSent)
      ...
      child: _isDropdownOpen
          ? Column(
              ...
              children: [
                ...
                Divider(height: 1, color: !isDarkMode ?  AppColors.black.withOpacity(.31) : AppColors.white.withOpacity(.31)),
                GestureDetector(
          ...
          Expanded(
            child: Padding(
              padding: EdgeInsets.only(
                  left: responsive.isMobile ? message.isUser ? 40.0 : 0 :  message.isUser ? 300.0 : 0 ,
                  right: responsive.isMobile ? message.isUser ? 0.0 : 40 :  message.isUser ? 0.0 : 300 ,
              ),
              child: Column(
